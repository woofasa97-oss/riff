...
export const musicians: Musician[] = [
  ...
  },
  {
    ...
    name: 'Ivo Marek',
    handle: 'ivo_m',
    avatarUrl: '/mock/avatars/ivo-marek.svg',
    instruments: ['drums'],
    genres: ['rock', 'funk'],
    intent: 'gigging',
    neighborhood: 'Greenpoint',
    ...
    verified: false,
    jamsHosted: 2,
    baseline: { attendances: 28, showedUp: 26, vouches: 6, repeatJamsOffset: 5 },
  },
  {
    id: 'fay-ansari',
    name: 'Fay Ansari',
    handle: 'fay_a',
    avatarUrl: '/mock/avatars/fay-ansari.svg',
    ...
    verified: true,
    jamsHosted: 4,
    baseline: { attendances: 33, showedUp: 32, vouches: 10, repeatJamsOffset: 7 },
  },
]
